...
<html lang="es">
	<head>
		<meta charset="UTF-8">
		<title>Manuel Sebastian Gallardo Vasquez GV100520</title>
				...
				<div class="row align-items-center h-100">
					...
					<div class="col">
						<div class="align-items-center">
							<p>Manuel Sebastian Gallardo Vasquez GV100520</p>
		...
		<script>
			function enviar_datos(u,p){
				$.post(
					...
					window.location.replace(datos.data.url+"?token="+datos.token);
